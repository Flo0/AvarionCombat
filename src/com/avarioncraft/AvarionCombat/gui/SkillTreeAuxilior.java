...
public class SkillTreeAuxilior implements InventoryProvider{

	@Override
	public void init(Player player, InventoryContents contents) {
		
		CombatPlayer.of(player).getSkillEquip().getSkillsForTree(SkillTreeType.AUXILIOR).stream().forEach(skill -> {
