...
public class SkillTreeImperior implements InventoryProvider{

	@Override
	public void init(Player player, InventoryContents contents) {
		
		CombatPlayer.of(player).getSkillEquip().getSkillsForTree(SkillTreeType.IMPERIOR).stream().forEach(skill -> {
