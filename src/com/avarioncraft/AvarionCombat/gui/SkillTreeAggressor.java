...
public class SkillTreeAggressor implements InventoryProvider{

	@Override
	public void init(Player player, InventoryContents contents) {
		
		CombatPlayer.of(player).getSkillEquip().getSkillsForTree(SkillTreeType.AGGRESSOR).forEach(skill -> {
