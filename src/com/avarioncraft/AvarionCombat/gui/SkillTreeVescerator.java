...
public class SkillTreeVescerator implements InventoryProvider{
	
	@Override
	public void init(Player player, InventoryContents contents) {
		
		CombatPlayer.of(player).getSkillEquip().getSkillsForTree(SkillTreeType.VESCERATOR).stream().forEach(skill -> {
